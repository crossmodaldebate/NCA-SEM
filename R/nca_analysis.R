...
perform_nca_analysis <- function(compiled_model, nca_type, nca_variables, jmv) {
  nca_results <- NCA::nca(compiled_model, nca_type, nca_variables)
...
# Main function to execute the complete NCA process
main <- function(jmv) {
  ...
  perform_nca_analysis(compiled_model, nca_type, nca_variables, jmv)
